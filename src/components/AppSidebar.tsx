import { LayoutDashboard, Users, KanbanSquare, CalendarCheck, Users2, Stethoscope, ClipboardList, LogOut, Bug } from 'lucide-react';
...
const navItems = [
  ...
  { icon: Bug, label: '🐛 Debug Tributos', to: '/debug-tributos' },
];
